    ...
    <div className="flex min-h-screen bg-[#212121]">
      ...
      <div className="w-1/2 relative flex items-center justify-center bg-cover">
        ...
        <blockquote className="absolute bottom-10 px-8 mb-10 text-2xl italic ■ text-white">
          <br />
          <span className="block mt-4 ■ text-yellow-400">Welcome to (NAME))!</span>
        </blockquote>
      </div>
      ...
      <div className="w-1/2 min-h-screen □ bg-[#1a1a1a] p-10">
        <div className="flex flexcol items-center gap-2">
          ...
          <h1 className="text-lg font-semibold ■ text-[#f5f5f5] tracking-wide">(NAME)</h1>
        </div>

        <h2 className="text-4xl text-center mt-10 font-semibold ■ text-yellow-400 mb-10">
          {isRegister ? "Member Registration" : "Member Login"}
        </h2>
